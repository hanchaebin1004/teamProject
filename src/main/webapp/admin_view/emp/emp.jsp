									...
									<tbody>
										<tr>
											...
											<td class="d-flex align-items-center border-top-0">
												<img class="profile-img img-sm img-rounded mr-2" src="<%=request.getContextPath()%>/assets_admin/images/profile/male/image_5.png" alt="profile image">
												<span>한채빈</span>
											</td>
											<td>과장</td>
											<td>01039082049</td>
										...
										<tr>
											...
											<td>02</td>
											<td class="d-flex align-items-center border-top-0">
												<img class="profile-img img-sm img-rounded mr-2" src="<%=request.getContextPath()%>/assets_admin/images/profile/male/image_7.png" alt="profile image">
												<span>양다연</span>
											</td>
											<td>대리</td>
											<td>01012341234</td>
												...
												<div class="grid">
													<div class="grid-body">
														<div class="item-wrapper">
															<div class="demo-wrapper">
																<div class="btn-group mb-0" data-toggle="buttons">
																	<label class="btn btn-outline-info active"> <input type="radio" name="options" id="option1_1" checked> <!-- <i class="mdi mdi-walk"> -->상</i>
																	</label> <label class="btn btn-outline-info"> <input type="radio" name="options" id="option1_2"> <!-- <i
																	class="mdi mdi-car"> -->중</i>
																	</label> <label class="btn btn-outline-info"> <input type="radio" name="options" id="option1_3"> <!-- <i
																	class="mdi mdi-train"> -->하</i>
																	</label>
																</div>
															</div>
										...
										<tr>
											...
											<td>03</td>
											<td class="d-flex align-items-center border-top-0">
												<img class="profile-img img-sm img-rounded mr-2" src="<%=request.getContextPath()%>/assets_admin/images/profile/female/image_10.png" alt="profile image">
												<span>박성범</span>
											</td>
											<td>본부장</td>
											<td>01045674567</td>
										...
										<tr>
											<td>04</td>
											<td class="d-flex align-items-center border-top-0">
												<img class="profile-img img-sm img-rounded mr-2" src="<%=request.getContextPath()%>/assets_admin/images/profile/female/image_1.png" alt="profile image">
												<span>창식쓰</span>
											</td>
											<td>대리</td>
											<td>01045674567</td>
										...
										<tr>
											<td>05</td>
											<td class="d-flex align-items-center border-top-0">
												<img class="profile-img img-sm img-rounded mr-2" src="<%=request.getContextPath()%>/assets_admin/images/profile/male/image_3.png" alt="profile image">
												<span>박보검</span>
											</td>
											<td>대리</td>
											<td>01045674567</td>
