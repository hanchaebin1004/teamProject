			...
			<div class="row">
				...
				<div class="col-lg-4 col-md-6 equel-grid">
					<div class="grid">
						<div class="grid-body d-flex flex-column h-100">
								...
								<div class="d-flex justify-content-between">
									<div class="split-header">
										<img class="img-ss mt-1 mb-1 mr-2"
											src="<%=request.getContextPath()%>/assets_admin/images/social-icons/instagram.svg"
											alt="instagram">
									...
									<div class="wrapper">
										<button class="btn action-btn btn-xs component-flat pr-0"
											type="button">
											<i class="mdi mdi-access-point text-muted mdi-2x"></i>
										</button>
										<button class="btn action-btn btn-xs component-flat pr-0"
											type="button">
							...
							<div class="mt-auto">
								<canvas class="curved-mode" id="followers-bar-chart"
									height="220"></canvas>
							</div>
						</div>
					</div>
				...
				<div class="col-lg-4 col-md-6 equel-grid">
					<div class="grid">
						<div class="grid-body">
							...
							<p class="text-center text-muted">Used balance this billing
								cycle</p>
						</div>
					</div>
				</div>
					...
					<div class="grid table-responsive">
						<table class="table table-stretched">
							...
							<tbody>
								<tr>
									<td>
										<p class="mb-n1 font-weight-medium">AAPL</p> <small
										class="text-gray">Apple Inc.</small>
									</td>
								...
								<tr>
									<td>
										<p class="mb-n1 font-weight-medium">NKE</p> <small
										class="text-gray">Nike,Inc.</small>
									</td>
								...
								<tr>
									<td>
										<p class="mb-n1 font-weight-medium">NSEI</p> <small
										class="text-gray">Nifty 50</small>
									</td>
								...
								<tr>
									<td>
										<p class="mb-n1 font-weight-medium">BA</p> <small
										class="text-gray">The Boeing Company</small>
									</td>
								...
								<tr>
									<td>
										<p class="mb-n1 font-weight-medium">SBUX</p> <small
										class="text-gray">Starbucks Corporation</small>
									</td>
						...
						<div class="grid-body d-flex flex-column h-100">
							<div class="split-header">
								...
								<div class="content-wrapper v-centered">
									<small class="text-muted">2h ago</small> <span
								...
								<tbody>
									<tr>
										<td class="pr-0 pl-4"><img class="profile-img img-sm"
											src="<%=request.getContextPath()%>/assets_admin/images/profile/male/image_4.png"
									...
									<tr>
										<td class="pr-0 pl-4"><img class="profile-img img-sm"
											...
											alt="profile image"></td>
										<td class="pl-md-0"><small
											class="text-black font-weight-medium d-block">Charlie
												Hawkins</small> <span class="text-gray"> <span
									...
									<tr>
										<td class="pr-0 pl-4"><img class="profile-img img-sm"
											...
											alt="profile image"></td>
										<td class="pl-md-0"><small
											class="text-black font-weight-medium d-block">Nina
												Bates</small> <span class="text-gray"> <span
									...
									<tr>
										<td class="pr-0 pl-4"><img class="profile-img img-sm"
											src="<%=request.getContextPath()%>/assets_admin/images/profile/male/image_10.png"
											alt="profile image"></td>
										<td class="pl-md-0"><small
											class="text-black font-weight-medium d-block">Hester
												Richards</small> <span class="text-gray"> <span
												class="status-indicator rounded-indicator small bg-success"></span>Email
												Verified
										</span></td>
				...
				<div class="col-md-4 equel-grid">
					<div class="grid">
							...
							<div class="split-header">
								...
								<div class="btn-group">
									...
									<div class="dropdown-menu dropdown-menu-right">
										<a class="dropdown-item" href="#">Expand View</a> <a
									...
									<div class="activity-log">
										...
										<div class="log-details">
											Analytics dashboard has been created<span
												class="text-primary ml-1">#Slack</span>
										</div>
										...
										<div class="log-details">
											...
											<div class="grouped-images mt-2">
												<img class="img-sm"
													...
													title="Gerald Pierce"> <img class="img-sm"
													src="<%=request.getContextPath()%>/assets_admin/images/profile/male/image_5.png"
													alt="Profile Image" data-toggle="tooltip"
													title="Edward Wilson"> <img class="img-sm"
													src="<%=request.getContextPath()%>/assets_admin/images/profile/female/image_6.png"
													alt="Profile Image" data-toggle="tooltip"
													title="Billy Williams"> <img class="img-sm"
													src="<%=request.getContextPath()%>/assets_admin/images/profile/male/image_6.png"
													alt="Profile Image" data-toggle="tooltip"
													title="Lelia Hampton"> <span class="plus-text img-sm">+3</span>
											</div>
										</div>
						...
						<a class="border-top px-3 py-2 d-block text-gray" href="#"> <small
							class="font-weight-medium"><i
								class="mdi mdi-chevron-down mr-2"></i> View All </small>
						</a>
					</div>
				</div>
			</div>
