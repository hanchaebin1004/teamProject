	...
	<div class="container">
		<div class="row">
			<div class="col-xl-12 col-lg-12">
				...
				<!-- 만족도 작성 폼 -->
				<form method="POST" id="surveyUpdateCheckForm" name="surveyUpdateCheckForm" action="<%=request.getContextPath()%>/satisfaction/updateCheck">
